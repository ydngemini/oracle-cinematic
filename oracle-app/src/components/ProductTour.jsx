...
const STEPS = [
  { kind: 'tab', destination: 'today', anchor: '#tab-home', label: 'Today', title: 'Start with the next best work', detail: 'Review appointments, overdue tasks, active deals, and evidence-backed priorities before opening individual records.', verify: 'Counts and recommendations should reflect live CRM records, never sample data.' },
  { kind: 'tab', destination: 'people', anchor: '#tab-work', label: 'People', title: 'One relationship record', detail: 'Search contacts, manage buyer and seller opportunities, open the full activity history, and keep assignment ownership explicit.', verify: 'Try an exact email, phone, or name-prefix search and open a contact drawer.' },
  { kind: 'tab', destination: 'inbox', anchor: '#tab-work', label: 'Inbox', title: 'Every conversation in context', detail: 'Work email, SMS, and call history alongside the contact and opportunity that produced it.', verify: 'Outbound drafts remain reviewable and channels stay unavailable until their provider validates.' },
  { kind: 'tab', destination: 'deals', anchor: '#tab-work', label: 'Deals', title: 'Search to settlement', detail: 'Track offer stages, deadlines, documents, state checklists, transaction milestones, and compliance holdings in one workflow.', verify: 'Open a deal and confirm deadlines and documents remain tied to the correct tenant and transaction.' },
  { kind: 'workspace', destination: 'cowork', anchor: '#tab-work', label: 'Our AI · Cowork', title: 'Command the operating system', detail: 'Ask NEOH to research, summarize, compare, and stage work across the CRM while retaining source and approval boundaries.', verify: 'Ask for a revenue brief and inspect the cited records before accepting any recommendation.' },
  { kind: 'workspace', destination: 'sales', anchor: '#tab-work', label: 'Our AI · Sales', title: 'Turn CRM truth into action', detail: 'Prioritize leads, qualify intent, draft personalized follow-up, and hand the full context back to the human agent.', verify: 'Capability badges come from live backend and provider health—not marketing copy.' },
